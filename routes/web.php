...
Route::prefix('front')->group(function () {
    ...
    Route::post('register', 'front\FrontAuth@register')->name('front.register');
});
...
Route::group(['middleware' => 'front'], function () {
    ...
    // favorite
    Route::get('/favorite/{id}', 'front\FrontController@favorite')->name('favorite');
    ...
    Route::get(
        'all-categories',
        'Dashboard\ProductController@getCategories'
    )->name('all-categories');
});

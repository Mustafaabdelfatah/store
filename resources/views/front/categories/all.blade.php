                ...
                <div class="sidebar-categories">
                    ...
                    <ul class="main-categories">
                        @foreach ($categories as $category)
                            <li class="main-nav-list"><a data-toggle="collapse" href="#cat_{{ $category->id }}"
                                    aria-expanded="false" aria-controls="cat_{{ $category->id }}"><span
                                        class="lnr lnr-arrow-right"></span>{{ $category->name }}<span
                                        class="number">{{ $category->child_categories->count() }}</span></a>
                                @foreach ($category->child_categories as $cat)
                                    <ul class="collapse" id="cat_{{ $cat->parent_id }}" data-toggle="collapse"
                                        aria-expanded="false" aria-controls="cat_{{ $cat->parent_id }}">
                                        <li class="main-nav-list child"><a href="#">{{ $cat->name }}<span
                                                    class="number">{{ $cat->products->count() }}</span></a></li>
                                    </ul>
                                @endforeach
                            </li>
                        @endforeach
                        ...
                        @foreach ($products as $product)
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-product">
                                    <img class="img-fluid"
                                        src="{{ asset('uploads/') }}/products/cover/{{ $product->cover }}" alt="">
                                    <div class="product-details">
                                        <h6>{{ $product->description }}</h6>
                                        <div class="price">
                                            <h6>{{ $product->price - $product->discount }}</h6>
                                        ...
                                        <div class="prd-bottom">
                                            ...
                                            <a href="{{ route('favorite', ['id' => $product->id]) }}"
                                                class="social-info">

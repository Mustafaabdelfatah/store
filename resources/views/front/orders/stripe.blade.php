        ...
        <div class="row">
            <div class="col-md-9" style="text-align: center">
                <p class="mb-4">
                    ...
                    <p>Your order number is {{ Session::get('order_id') }} and total payable about is $
                ...
                <form style="margin-top: 50px" action="{{ route('payWithStripe') }}" method="post" id="payment-form">
                    @csrf
                    <div class="">
...
<script>
    window.onload = function () {
        var stripe = Stripe('pk_test_51H5wsmCfBQ2xNRYl7hwJLLMeAmfhzippnq3HrlCZFseYX677XnXXCq93neqQOn4JXzZjK3Yj9r3i22paLol4QC1G00CSido6n3');

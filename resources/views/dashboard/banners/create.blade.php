                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('link') }}" id="link" required
                                        class="form-control" placeholder=" " name="link" required>
                                    @error('link')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea required name="desc" class="form-control" id="" rows="5"></textarea>
                                    @error('desc')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
